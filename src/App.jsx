...
const App = () => {
  ...
  const handleSearch = (searchText) => {
    ...
    const inputQuery = searchText.toLowerCase();
    const filteredQuery= books.filter((book)=>
      book.title.toLowerCase().includes(inputQuery)
    ) 
    setFilteredBooks(filteredQuery)
  };
